# Lesson 2 — Selection Log: أَشْهَدُ أَنْ لَا إِلَٰهَ إِلَّا ٱللَّهُ

Anchor phrase: **أَشْهَدُ أَنْ لَا إِلَٰهَ إِلَّا ٱللَّهُ**
Root word: **شَهِدَ** (shahida)
...
## Root word: شَهِدَ (shahida) — root ش ه د

### Corpus inventory (9 forms, 160 total occurrences)

| # | Category | Form | Transliteration | Gloss | Count |
|---|----------|------|-----------------|-------|-------|
| 1 | Verb (I) | شَهِدَ | shahida | to testify, bear witness | 44 |
| 2 | Verb (IV) | أَشْهَدَ | ashhada | to make witness | 7 |
| 3 | Verb (X) | اسْتَشْهَدَ | istashhada | to call to witness | 2 |
| 4 | Noun | شَهَادَة | shahāda | testimony | 23 |
| 5 | Noun (pl) | شَهَادَات | shahādāt | testimonies | 3 |
| 6 | Noun | مَشْهَد | mashhad | witnessing | 1 |
| 7 | Nominal | شَهِيد | shahīd | witness / martyr | 56 |
| 8 | Participle | شَاهِد | shāhid | witness (active) | 21 |
| 9 | Participle | مَشْهُود | mashhūd | witnessed (passive) | 3 |

### Table entries shown in lesson (4 forms + shahāda noun)

| # | Arabic | Transliteration | English | Ordering logic |
|---|--------|----------------|---------|---------------|
| 1 | شَهِدَ | shahida | testified / bore witness | Base verb |
| 2 | شَهَادَة | shahāda | testimony | The noun behind "shahādah" |
| 3 | شَهِيد | shahīd | witness | The student already knows this word |
| 4 | شَاهِد | shāhid | one who witnesses | Active participle |

**Not shown in table (deferred to future lessons):** أَشْهَدَ (Form IV), اسْتَشْهَدَ (Form X), مَشْهَد, مَشْهُود, شَهَادَات — all low-count or less pedagogically central.

### Anchor phrase (teacher-made from adhān)

| Ref | Arabic | English | Why chosen |
|-----|--------|---------|-----------|
| adhān (second call) | أَشْهَدُ أَنْ لَا إِلَٰهَ إِلَّا ٱللَّهُ | I bear witness that there is no god but Allah | The second line of the adhān — every Muslim hears and says it daily. Contains the form أَشْهَدُ directly, and bridges back to Lesson 1 via لَا إِلَٰهَ إِلَّا. The entire shahādah is built on this root. |
...
|---|-----|--------|------|---------|-----------|
| 1 | 3:53 | رَبَّنَآ ءَامَنَّا بِمَآ أَنزَلْتَ وَٱتَّبَعْنَا ٱلرَّسُولَ فَٱكْتُبْنَا مَعَ **ٱلشَّٰهِدِينَ** | شَاهِد (plural) | Our Lord, we believe in what You have sent down and followed the Messenger — so write us among the witnesses | Duʿā of Isa's disciples. Story-bearing. Gives شَاهِد in plural form (الشَّاهِدِين). |
| 2 | 63:1 | إِذَا جَآءَكَ ٱلْمُنَـٰفِقُونَ قَالُوا۟ **نَشْهَدُ** إِنَّكَ لَرَسُولُ ٱللَّهِ ۗ وَٱللَّهُ **يَشْهَدُ** إِنَّ ٱلْمُنَـٰفِقِينَ لَكَـٰذِبُونَ | نَشْهَدُ / يَشْهَدُ | The hypocrites say "we testify you are Allah's Messenger." But Allah testifies that the hypocrites are liars | **Dramatic exposé.** Two forms of شَهِدَ in opposition — the hypocrites "testify" vs. Allah "testifies." Opening verse of Surah Al-Munāfiqūn. |
| 3 | 41:20 | **شَهِدَ** عَلَيْهِمْ سَمْعُهُمْ وَأَبْصَـٰرُهُمْ وَجُلُودُهُم بِمَا كَانُوا۟ يَعْمَلُونَ | شَهِدَ | Their hearing, their sight, and their skins testified against them for what they used to do | Day of Judgment — body parts themselves testify against their owners. Short, vivid, shocking imagery. |
| 4 | 3:81 (trimmed) | قَالَ فَ**ٱشْهَدُوا۟** وَأَنَا۠ مَعَكُم مِّنَ **ٱلشَّـٰهِدِينَ** | اشْهَدُوا + الشَّاهِدِينَ | He said: Then bear witness, and I am with you among the witnesses | Prophets' covenant — Allah to the prophets: "bear witness." Two forms in one phrase (imperative + active participle plural). |
| 5 | 4:69 (trimmed) | مَعَ ٱلَّذِينَ أَنْعَمَ ٱللَّهُ عَلَيْهِم مِّنَ ٱلنَّبِيِّـۧنَ وَٱلصِّدِّيقِينَ وَ**ٱلشُّهَدَآءِ** وَٱلصَّـٰلِحِينَ | شُهَدَاء | With those Allah has blessed — the prophets, the truthful, the witnesses/martyrs, and the righteous | **The four ranks.** Teaches شُهَدَاء (plural) in a famous context — the four categories of Allah-blessed people. **Teacher moved this from Pipeline to Practice** — it's too well-known to defer. |

---

## Recall phrases (5, from Lesson 1 roots)

Recall is a **new section** starting Lesson 2. These verses are all from Lesson 1's roots (إِلَٰه and كَبُرَ) — they don't teach new forms, they reinforce recognition of forms the student has already met. Verse selection favours (a) bridge verses that also contain a L2 form, (b) verses that give a fresh context for an L1 form.

| # | Ref | Arabic | Root / Form | English | Why chosen |
|---|-----|--------|-------------|---------|-----------|
| 1 | 39:46 (trimmed) | قُلِ **ٱللَّهُمَّ** فَاطِرَ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضِ عَـٰلِمَ ٱلْغَيْبِ وَ**ٱلشَّهَٰدَةِ** | إِلَٰه (اللَّهُمَّ) **+ L2 شَهَادَة** | Say: O Allah, Creator of heavens and earth, Knower of the unseen and the witnessed | **The bridge verse par excellence.** Contains BOTH اللَّهُمَّ (L1 recall) AND الشَّهَادَة (L2 — showing the root's other shade: "the witnessed/seen" as opposite of "the unseen"). A single verse that activates both lessons. |
| 2 | 38:5 | أَجَعَلَ **ٱلْءَالِهَةَ** **إِلَٰهًۭا** وَٰحِدًا ۖ إِنَّ هَٰذَا لَشَىْءٌ عُجَابٌ | إِلَٰه (both آلِهَة + إِلَٰه) | Has he made all the gods into one God?! This is astonishing! | Quraysh mocking the Prophet ﷺ — both singular (إِلَٰه) and plural (آلِهَة) in one phrase. Dramatic, rare to hear both forms adjacent. |
| 3 | 20:14 | إِنَّنِىٓ أَنَا ٱللَّهُ لَآ **إِلَٰهَ** إِلَّآ أَنَا۠ فَٱعْبُدْنِى وَأَقِمِ ٱلصَّلَوٰةَ لِذِكْرِىٓ | إِلَٰه | Indeed I am Allah — there is no god but Me — so worship Me and establish prayer for My remembrance | **Allah speaking directly to Mūsā at the burning bush.** Iconic prophet story. Famous ṣalāh verse. Reinforces the لَا إِلَٰهَ إِلَّا pattern from L1's anchor (59:22). |
| 4 | 40:57 | لَخَلْقُ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضِ **أَكْبَرُ** مِنْ خَلْقِ ٱلنَّاسِ | كَبُرَ (أَكْبَرُ) | The creation of the heavens and earth is greater than the creation of mankind | Cosmic-scale perspective on أَكْبَرُ — the word the student already knows from اللهُ أَكْبَرُ, now used to compare cosmic to human scale. |
| 5 | 54:53 | وَكُلُّ صَغِيرٍۢ وَ**كَبِيرٍۢ** مُّسْتَطَرٌ | كَبُرَ (كَبِير) | Every small and great thing is recorded | **Ultra-short (4 words).** From Surah Al-Qamar. Pairs كَبِير with its opposite صَغِير for contrast. |

---

## Phrases moved to pipeline
...
| شَهَادَات | shahādāt (pl) | 3 | Low | Plural of testimony. |

---

## Audio notes

### Reciter assignments (to be filled in Phase 3)

Each phrase needs a distinct reciter from the pool in `docs/decisions/ADR-005-reciters.md`. Reciter assignment will be made during audio preparation.

### Trim notes for audio builder
