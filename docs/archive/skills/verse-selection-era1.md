> **Status (2026-04-17):** Archived. Era-1 lesson-authoring workflow; superseded by [PRD §5.F0-F4](../../PRD.md) + the InstantDB picker workflow in [.claude/skills/instantdb-picker-workflow.md](../../../.claude/skills/instantdb-picker-workflow.md). Content preserved for historical reference.
